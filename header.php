...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="logopanel">
        <h1><span>[</span> SaboreWeb <span>]</span></h1>
    </div><!-- logopanel -->
    ...
    <div class="leftpanelinner">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent"><a href=""><i class="fa fa-edit"></i> <span>Formulários</span></a>
          <ul class="children">
        ...
        <li class="nav-parent"><a href=""><i class="fa fa-suitcase"></i> <span>Elementos Front</span></a>
          <ul class="children">
        ...
        <li><a href="tables.html"><i class="fa fa-th-list"></i> <span>Tabelas</span></a></li>
        <li><a href="maps.html"><i class="fa fa-map-marker"></i> <span>Mapas</span></a></li>
        <li class="nav-parent"><a href=""><i class="fa fa-file-text"></i> <span>Páginas</span></a>
          <ul class="children">
        ...
        <li class="nav-parent"><a href="layouts.html"><i class="fa fa-laptop"></i> <span>Telas</span></a>
            <ul class="children">
          ...
          <li>
            <div class="btn-group">
              ...
              <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                ...
                <li><a href="signin.html"><i class="glyphicon glyphicon-log-out"></i> Deslogar</a></li>
              </ul>
            </div>
          </li>
          <li>
